import { getNepaliDayOfWeek } from './getNepaliDayOfWeek';
import { yearsWithMonthDaysInBsForEnglishDate } from "../constants/YearWithMonthDaysInBs";
import { isEnglishDateInRange } from "./isEnglishDateInRange";
import { isLeapYear } from "./isLeapYear";
import { getNepaliMonth } from './getNepaliMonth';
import { getNepaliDays } from './getNepaliDays';

export const EnglishToNepaliDateConverter = (inputYear: any, inputMonth: any, inputDay: any) => {
