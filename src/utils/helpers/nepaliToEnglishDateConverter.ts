...
import { getEnglishDayOfWeek } from "./getEnglishDayOfWeek";
import { getEnglishMonth } from "./getEnglishMonth";
import { isLeapYear } from "./isLeapYear";
import { isNepaliDateInRange } from "./isNepaliDateInRange";

export function NepaliToEnglishDateConverter(inputYear:number, inputMonth:number, inputDay:number)
{
    ...
    if (!dateCheck) {
      ...
      let result = {
        ...
        monthName: getEnglishMonth(month),
      };
